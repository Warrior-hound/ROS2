  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: turn_on_off
  {
    cdr << (ros_message->turn_on_off ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: turn_on_off
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->turn_on_off = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name turn_on_off
  {
    size_t item_size = sizeof(ros_message->turn_on_off);

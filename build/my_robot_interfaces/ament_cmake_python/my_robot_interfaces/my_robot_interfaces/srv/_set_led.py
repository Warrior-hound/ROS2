...
class SetLed_Request(metaclass=Metaclass_SetLed_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.turn_on_off = kwargs.get('turn_on_off', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.turn_on_off != other.turn_on_off:
            return False
        return True
    ...
    def turn_on_off(self):
        """Message field 'turn_on_off'."""
        return self._turn_on_off
    ...
    def turn_on_off(self, value):
        if __debug__:
            assert \
                ...
                "The 'turn_on_off' field must be of type 'bool'"
        self._turn_on_off = value

...
#include "ros2_ir/ros2_ir_plugin.hpp"     // Header file.
...
void GazeboRosRaySensorPrivate::PublishRange(ConstLaserScanStampedPtr & _msg)
{
  ...
  auto range_msg = gazebo_ros::Convert<sensor_msgs::msg::Range>(*_msg);
   ...
   if (range_msg.range == std::numeric_limits<float>::max()) {
    range_msg.range = range_msg.max_range;
  }

  // std::cout << "Converted range message:" << std::endl;
  // std::cout << "Header:" << std::endl;
  // std::cout << "  Stamp: " << range_msg.header.stamp.sec << "s " << range_msg.header.stamp.nanosec << "ns" << std::endl;
  // std::cout << "  Frame ID: " << range_msg.header.frame_id << std::endl;
  // std::cout << "Radiation type: " << static_cast<int>(range_msg.radiation_type) << std::endl;
  // std::cout << "Field of view: " << range_msg.field_of_view << std::endl;
  // std::cout << "Min range: " << range_msg.min_range << std::endl;
  // std::cout << "Max range: " << range_msg.max_range << std::endl;
  // std::cout << "Range: " << range_msg.range << std::endl;

  // Set tf frame
  range_msg.header.frame_id = frame_name_;

  //   std::cout << "Final range message:" << std::endl;
  // std::cout << "Header:" << std::endl;
  // std::cout << "  Stamp: " << range_msg.header.stamp.sec << "s " << range_msg.header.stamp.nanosec << "ns" << std::endl;
  // std::cout << "  Frame ID: " << range_msg.header.frame_id << std::endl;
  // std::cout << "Radiation type: " << static_cast<int>(range_msg.radiation_type) << std::endl;
